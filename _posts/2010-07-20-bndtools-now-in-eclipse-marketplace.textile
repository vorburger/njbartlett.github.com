...
To install Bndtools, open the Help menu in Eclipse and select Eclipse Marketplace. If this is the first time you have used it you may have to select Eclipse Marketplace as your solution catalog rather than Yoxos Marketplace. Then in the search field type "bndtools" (just "bnd" will work also) and click Go:
