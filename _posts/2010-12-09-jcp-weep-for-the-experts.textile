...
A deep understanding that principle, and of the value of diversity, led Sun to create the JCP. Java became strong not as a barbershop quartet singing in perfect harmony, but as a massive, heaving soccer crowd baying for their team. The neutering of the JCP threatens to turn that crowd into a bunch of North Korean rent-a-fans.
...
The primary remaining motivator is *money*. Experts will be drawn from the set of people paid by Oracle, directly or indirectly. Oracle employees, obviously. IBM employess too, since it's clear that Oracle wrote IBM a fat cheque to get them to abandon Harmony and join OpenJDK... the details of the deal are private but I _sincerely_ hope they emerge on WikiLeaks some day.
